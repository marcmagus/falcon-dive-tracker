...
ScriptHost:AddVariableWatch("locations", {
    ...
    "Upper Babel/Upper Babel [4-7]",
    "Upper Babel/Upper Babel [4-7]",
    "Upper Babel/Upper Babel Monster [6-9]",
    ...
    "Lunar Subterranae/Murasame Altar",
    "Lunar Subterranae/Crystal Sword Altar",
    "Lunar Subterranae/White Spear Room",
    "Lunar Subterranae/Ribbon Room",
    "Lunar Subterranae/Masamune Altar",
    "Lunar Subterranae/Lunar Subterrane [6-8]",
    "Lunar Subterranae/Lunar Subterrane Monster [7-9]",
    "Lunar Subterranae/Lunar Core [7-9]",
