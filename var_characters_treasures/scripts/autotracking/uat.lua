...
characters = {"dkCecil","kain","rosa","rydia","cid","tellah","edward","yang","palom","porom","edge","fusoya","cecil","golbez"}

function updateCharacters (store, vars)
...
ScriptHost:AddVariableWatch("progressiveToggles", {
    "character-1",
    "character-2",
    "character-3",
    "character-4",
...
-- ScriptHost:AddVariableWatch("character", {
--     "character-1-job",
--     "character-2-job",
--     "character-3-job",
--     "character-4-job",
...
ScriptHost:AddVariableWatch("locations", {
    ...
    "Troia/Tower of Zot Monster [6-7]",
    ...
    "Eblan Castle/Eblan Castle Monster [5-6]",
    ...
    "Lower Babel/Tower of Babel Monster [7-8]",
    "Cave of Summons/Asura",
    "Cave of Summons/Leviathan",
    "Cave of Summons/Cave of Summons [4-7]",
    "Cave of Summons/Cave of Summons Monster [7-8]",
    ...
    "Sylvan Cave/Sylvan Cave Monster [7-8]",
    ...
    "Lunar Subterrane/Lunar Subterrane Monster [8-9]",
